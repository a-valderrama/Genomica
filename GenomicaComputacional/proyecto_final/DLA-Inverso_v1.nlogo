...
to wander   ;; turtle procedure
  ...
  ;; set particle to a branch edge if in area already explored
  if neighbors with [pcolor = green] = 8
    [
      move-to max-one-of turtles [distance myself]
    ]
  ;; if the patch has already been visited
  if pcolor = green
    [
      rt random 70
      fd 1
